                  ...
                  <CardContent className="space-y-4">
                    ...
                    {encryptionEnabled && (
                      <Alert>
                        ...
                        <AlertDescription>
                          <strong>Important:</strong> Your data is encrypted using your API key.
                          If you rotate your API key, the system will automatically re-encrypt your data with the new key.
                          Always ensure your API key is saved in your browser before performing key rotations.
                        </AlertDescription>
                      </Alert>
                    )}
                  </CardContent>
